...
const domesticHotelRoute = require("./routes/domesticHotel")
const internationalHotelRoute = require("./routes/internationalHotel")
...
app.use("/api/v1", domesticHotelRoute);
app.use("/api/v1", internationalHotelRoute);
